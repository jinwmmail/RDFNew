...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" Width="700px" runat="server" LabelWidth="120px"
        ...
        <Items>
            <x:RadioButtonList ID="RadioButtonList1" Label="列表一" runat="server">
                ...
                <x:RadioItem Text="可选项 2" Value="value2" Selected="true" />
            ...
            <x:RadioButtonList ID="RadioButtonList2" Label="列表二（竖排）" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </x:RadioButtonList>
            ...
            <x:RadioButtonList ID="RadioButtonList4" Label="列表四（空列表）" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </x:RadioButtonList>
    ...
    <br />
    <x:RadioButtonList ID="RadioButtonList3" Width="700px" Label="列表三" ColumnNumber="3"
        ...
        <x:RadioItem Text="可选项 5" Value="value5" Selected="true" />
        <x:RadioItem Text="可选项 6" Value="value6" Selected="true" />
        <x:RadioItem Text="可选项 7" Value="value7" Selected="true" />

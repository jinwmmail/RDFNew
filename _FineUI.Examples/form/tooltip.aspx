...
<body>
    ...
    <x:Label ID="Label1" Text="中国科学技术大学" ToolTipTitle="中国科学技术大学" ToolTip="中国科学技术大学是中国科学院所属的一所以前沿科学和高新技术为主、兼有特色管理和人文学科的综合性全国重点大学。"
        runat="server">
    </x:Label>
    <br />
    <x:HyperLink ID="HyperLink1" Text="中国科学技术大学" ToolTip="1958年9月创建于北京，首任校长由郭沫若兼任。它的创办被称为“我国教育史和科学史上的一项重大事件”。"
        ToolTipTitle="中国科学技术大学" Target="_blank" NavigateUrl="http://www.ustc.edu.cn/"
        runat="server">
    </x:HyperLink>
    <br />
    <x:Image ID="Image1" runat="server" Icon="World" ToolTip="这是一张象征地球的图片">
    </x:Image>
    <br />

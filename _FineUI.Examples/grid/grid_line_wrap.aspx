...
<body>
    ...
    <x:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" Width="800px" Height="400px"
        ...
        <Columns>
            ...
            <x:HyperLinkField Width="120px" HeaderText="所学专业" DataToolTipField="Major" DataTextField="Major"
                DataTextFormatString="{0}" DataNavigateUrlFields="Major" DataNavigateUrlFormatString="http://gsa.ustc.edu.cn/search?q={0}"
                DataNavigateUrlFieldsEncode="true" Target="_blank" />
            <x:BoundField ExpandUnusedSpace="true" DataField="Desc" HeaderText="个人简介" />
        </Columns>
    </x:Grid>
    <br />
    <br />

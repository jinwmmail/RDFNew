<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_text_top.aspx.cs"
    Inherits="FineUI.Examples.grid.grid_text_top" %>
...
<body>
    ...
    <x:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="表格" Width="800px" Height="400px"
        RowVerticalAlign="Top" runat="server" DataKeyNames="Guid">
        <Columns>
            ...
            <x:ImageField Width="120px" ImageWidth="48px" DataImageUrlField="Group" DataImageUrlFormatString="~/images/16/{0}.png"

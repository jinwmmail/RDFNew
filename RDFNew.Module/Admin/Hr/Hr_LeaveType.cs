...
{
    public class Hr_LeaveType : ISingle
    {
        const string MTABLE = "Hr_LeaveType";
        const string MKEY = "LeaveTypeID";
            ...
            try
            {
                ...
                else
                {
                    ...
                    Select Top {2} 
                            Hr_LeaveType.* 
                    From Hr_LeaveType 
                    Where 1=1 {0} And Hr_LeaveType.LeaveTypeID Not In (
                        Select Top {3} Hr_LeaveType.LeaveTypeID 
                        From Hr_LeaveType 
                        Where 1=1 {0}      
                        {1}                      
                    ) 

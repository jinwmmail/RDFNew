<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bas_DeptList.aspx.cs" Inherits="RDFNew.Web.Admin.Bas.Dept.Bas_DeptList" %>
    ...
    <x:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
        ...
        <Regions>
                    ...
                    <x:Form ID="FormQuery" runat="server" ShowBorder="false" ShowHeader="false" LabelWidth="60px">
                        <Rows>
                            <x:FormRow ColumnWidths="130px 230px">
                                <Items>
                                    <x:TextBox ID="txtDeptID" runat="server" Text="" Width="60px" Label="部门编号" NextFocusControl="txtDeptName">
                                    </x:TextBox>
                                    <x:TextBox ID="txtDeptName" runat="server" Text="" Width="160px" Label="部门名称" NextFocusControl="txtDeptID">
                                    </x:TextBox>
                                </Items>
                            </x:FormRow>
                        </Rows>
            ...
            <x:Region ID="Region2" runat="server" Position="Center" ShowBorder="false" ShowHeader="false"
                Layout="Fit">
                <Items>
                    <x:Grid ID="Grid1" Title="部门列表" PageSize="50" ShowBorder="false" ShowHeader="true"
                        AutoHeight="true" AllowPaging="true" runat="server" EnableMultiSelect="false"
                        DataKeyNames="DeptID" IsDatabasePaging="true" OnPageIndexChange="Grid1_PageIndexChange"
                        OnSort="Grid1_Sort" EnableRowNumber="True" AllowSorting="true" EnableTextSelection="true"
                        OnRowCommand="Grid1_RowCommand">
                        <Columns>
                            <x:LinkButtonField runat="server" HeaderText="部门编号" DataTextField="DeptID" Width="95"
                                CommandName="View" />
                            <x:BoundField DataField="DeptName" Hidden="true" /> 
                            <x:BoundField DataField="RID" Hidden="true" /> 
                            <x:BoundField Width="200px" DataField="DeptName" HeaderText="部门名称"

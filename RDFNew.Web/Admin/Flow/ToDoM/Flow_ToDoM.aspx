<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_ToDoM.aspx.cs" Inherits="RDFNew.Web.Admin.Flow.ToDoM.Flow_ToDoM" %>
                            ...
                            <x:Tab ID="Tab2" runat="server" Layout="Fit" Title="明细列表">
                                ...
                                <Items>
                                    <x:Grid ID="Grid1" ShowHeader="false" PageSize="50" ShowBorder="false" AutoHeight="true"
                                        ...
                                        <Columns>
                                            <x:BoundField DataField="Seq" HeaderText="序号" Width="45" />

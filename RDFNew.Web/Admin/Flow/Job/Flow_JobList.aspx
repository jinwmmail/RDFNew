<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_JobList.aspx.cs" Inherits="RDFNew.Web.Admin.Flow.Job.Flow_JobList" %>
            ...
            <x:Region ID="Region2" runat="server" Position="Center" ShowBorder="false" ShowHeader="false"
                ...
                <Items>
                    <x:Grid ID="Grid1" Title="职位列表" PageSize="50" ShowBorder="false" ShowHeader="true"
                        ...
                        <Columns>
                            <x:LinkButtonField runat="server" HeaderText="职位编号" DataTextField="JobID" SortField="Flow_Job.JobID"
                                Width="75" CommandName="View" />                            
                            <x:BoundField Width="150px" DataField="JobName" SortField="Flow_Job.JobName" HeaderText="职位名称" />                            

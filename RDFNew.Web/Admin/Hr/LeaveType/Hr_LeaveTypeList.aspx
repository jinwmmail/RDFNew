<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hr_LeaveTypeTypeList.aspx.cs"
    Inherits="RDFNew.Web.Admin.Hr.LeaveType.Hr_LeaveTypeList" %>
                    ...
                    <x:Form ID="FormQuery" runat="server" ShowBorder="false" ShowHeader="false" LabelWidth="60px">
                        <Rows>
                            <x:FormRow ColumnWidths="130px 230px">
                                <Items>
                                    <x:TextBox ID="txtLeaveTypeID" runat="server" Text="" Width="60px" Label="类别编号" NextFocusControl="txtLeaveTypeName">
                                    </x:TextBox>
                                    <x:TextBox ID="txtLeaveTypeName" runat="server" Text="" Width="160px" Label="类别名称"
                                        NextFocusControl="txtLeaveTypeID">
                                    </x:TextBox>
                                </Items>
                            </x:FormRow>
                        </Rows>
            ...
            <x:Region ID="Region2" runat="server" Position="Center" ShowBorder="false" ShowHeader="false"
                ...
                <Items>
                    <x:Grid ID="Grid1" Title="类别列表" PageSize="50" ShowBorder="false" ShowHeader="true"
                        ...
                        DataKeyNames="LeaveTypeID" IsDatabasePaging="true" OnPageIndexChange="Grid1_PageIndexChange"
                        OnSort="Grid1_Sort" EnableRowNumber="True" AllowSorting="true" EnableTextSelection="true"
                        OnRowCommand="Grid1_RowCommand">
                        <Columns>
                            <x:LinkButtonField runat="server" HeaderText="类别编号" DataTextField="LeaveTypeID" SortField="Hr_LeaveType.LeaveTypeID"
                                Width="75" CommandName="View" />
                            <x:BoundField Width="150px" DataField="LeaveTypeName" SortField="Hr_LeaveType.LeaveTypeName"
                                HeaderText="类别名称" />
                            <x:CheckBoxField Width="35px" DataField="IsSalary" SortField="Hr_LeaveType.IsSalary"
                                HeaderText="有薪<br/>假" TextAlign="Center" />
                            <x:CheckBoxField Width="35px" DataField="Enabled" SortField="Hr_LeaveType.Enabled"
                                HeaderText="是否<br/>有效" TextAlign="Center" />
